...
namespace Tests
{
    ...
    public class BasicTests
    {
        ...
        public void EnumeratorValidation()
        {
            ...
            {
                Assert.AreEqual(bfs[i], maybeBfs[i]);
            }
        ...
        public void ChildrenPropertyValidation()
        {
            ...
            var acceptableExceptionaryTypes = new List<Type>()
            {
            ...
            foreach (var et in editableTypes)
            {
                ...
                {
                    Assert.IsTrue(acceptableExceptionaryTypes.Any(t => type == t || type.IsSubclassOf(t)));
                }
            }
